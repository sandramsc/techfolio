...
const style = {
wrapper: `flex-[0.6] px-4 flex flex-col`,
  twitterIconContainer: `text-3xl m-4`,
  tweetButton: `bg-[#1d9bf0] hover:bg-[#1b8cd8] flex items-center justify-center font-bold rounded-3xl h-[50px] w-[150px] mt-[20px] cursor-pointer`,
  navContainer: `flex-1`,
